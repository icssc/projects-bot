/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: fd61856598d1fd352e9b6d1f8a0e25bf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASANA_WEBHOOK_SECRET">> {}
}
